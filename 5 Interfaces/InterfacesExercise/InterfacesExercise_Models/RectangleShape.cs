...
{
    /// <summary>
    /// Represents a rectangular shape with position, size, and movement capabilities.
    /// </summary>
    public class RectangleShape : IShape, IMovable
    {
        /// <summary>
        ...
        /// <summary>
        /// Moves the rectangle up by decreasing the Y-coordinate.
        /// </summary>
        public void MoveUp()
        {
            Y -= 10;
        ...
        /// <summary>
        /// Moves the rectangle down by increasing the Y-coordinate.
        /// </summary>
        ...
        /// <summary>
        /// Moves the rectangle left by decreasing the X-coordinate.
        /// </summary>
        ...
        /// <summary>
        /// Moves the rectangle right by increasing the X-coordinate.
        /// </summary>
